...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.layer1_norm = nn.LayerNorm(model_dim)
        self.layer2_norm = nn.LayerNorm(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        embedded = embedded + self.attention(self.layer1_norm(embedded))
        embedded = embedded + self.linear_network(self.layer2_norm(embedded))
